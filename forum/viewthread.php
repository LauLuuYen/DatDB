    ...
    <div class="container2">
        <form ng-submit="submit()">
            ...
            <div class="input_wrapper">
                <textarea cols="95" rows="3" class="input_text content" ng-model="thread.comment" ng-change="onChange('comment_e')" placeholder="New Comment (500 comments maximum)" maxlength="500"></textarea>
